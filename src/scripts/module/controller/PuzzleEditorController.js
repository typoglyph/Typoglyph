...
define([
	...
	"util/Utils",
	"./ContentController"
], function(Interact, Gap, Option, AlwaysCorrectPuzzleGapDrawer, PuzzleGapDrawer,
		PuzzleOptionBarDrawer, PuzzleOptionDrawer, TabulatedPuzzleDrawer, Arrays, Objects, Utils,
		ContentController) {
	...
	return Objects.subclass(ContentController, {
		...
		create: function(e) {
			...
			self.puzzleDrawer = TabulatedPuzzleDrawer.create(AlwaysCorrectPuzzleGapDrawer.create(optionDrawer));
